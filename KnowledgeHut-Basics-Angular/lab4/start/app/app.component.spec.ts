...
describe('AppComponent', () => {
  ...
  it('should display eight different license plates', () => {
    ...
    expect(getTextContent('h2', plates[0])).toBe('2008 Georgia license plate');
    expect(getTextContent('h2', plates[1])).toBe('2015 New Jersey license plate');
    expect(getTextContent('h2', plates[2])).toBe('2013 California My Tahoe license plate');
    expect(getTextContent('h2', plates[7])).toBe('2007 Pennsylvania license plate');
  });
